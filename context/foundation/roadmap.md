...
| F-03 | ui-foundation                           | (foundation) every screen draws its colours from shared theme tokens and its copy from an English/Polish message catalogue; the user can switch light/dark theme and language | —             | FR-025, FR-026, NFR dark default, NFR attribution | done |
